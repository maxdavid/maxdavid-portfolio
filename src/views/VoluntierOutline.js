  ...
  return (
    <div>
      <StyledProjectOutline>
        {/* <div className='header'><img src={} /></div> */}
        <h2 className='header'>
          VolunTier connects potential volunteers with local nonprofits who need
          some extra help.
        </h2>
        ...
        <p>
          ...
          For engineering, I worked extensively on converting mockups into React
          components, system debugging, and maintaining a Firebase backend.
        </p>
        <p>
        ...
        <p>
          There exists an asymmetry of information between potential volunteers
          and nonprofits offering opportunities. While there are many who enjoy
          volunteering,{' '}
          <mark>
            it seems they are unable to quickly and easily find opportunities
            that meet their preferences.
          </mark>{' '}
          Additionally, nonprofits frequently struggle to fill their roster with
        ...
        <p>
          ...
          at people with some experience in volunteer work. Using a combination
          of multiple choice, short answer, and longform questions, we hoped to
          learn more about volunteers and their motivations.
        </p>
        <p>
        ...
        <p>
          ...
          minute discussions of a mixture of prepared open-ended and contextual
          followup questions. We learned a number of key insights that guided
        ...
        <div className='grid-row'>
          ...
          <div>
            ...
            <p>
              ...
              volunteer are usually morality based, and that volunteering one’s
              time to an organization in need is universally considered good.
            </p>
            <p>
              Additionally, those interviewed all shared stories of volunteering
              as part of a group. From this, we reasoned that feeling like part
              of a community or movement is a major motivator for participating
              in volunteer work.
            </p>
          </div>
        </div>
        ...
        <p>
          We discovered that people want to know what they’re getting into when
          they sign up to volunteer. When there isn’t enough information about
          duties needed, personal requirements, or time expected, respondents
          said they often don’t sign up at all.
        </p>
        ...
        <p>
          ...
          invited them for a 30 minute interview to discover their pain points.
        </p>
        ...
        <p>
          ...
          prevalence of noshows. Without a way to keep signups accountable, not
          having enough hands for events happened too often.
        </p>
        <p>
          Additionally, there was no way to confirm that any given volunteer was
          a trustworthy asset. This especially concerned organizations that
          dealt with children or the elderly.{' '}
        </p>
        <h6>Administrative Burden</h6>
        <p>
          Many organizations required an application or interview before
          helping. Keeping track of applications and scheduling interviews would
          quickly become a paperwork nightmare.
        </p>
        <p>
          ...
          original assumptions, and we eventually integrated recurring events as
          a core of our product.
        </p>
        <h4 id='02c_'>User Personas</h4>
        <p>
          Our research cleared the fog on who our target audience needed to be.
          We created some user personas to help our team understand who to
          design for.
        </p>
        <div className='grid-row'>
          <figure>
        ...
        <p>
          ...
          nonprofits. By creating a space for both sides of the conversation to
          meet, we saw an opportunity to bridge the gap.
        </p>
        <p>
          This means we’ll need to cater to two types of users and their unique
          needs.
        </p>
        <div className='grid-row'>
          <div>
